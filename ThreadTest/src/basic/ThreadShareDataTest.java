 ...
 * 1. 공통으로 사용할 데이터를 클래스로 정의 한다.
 * 2. 공통으로 사용할 클래스의 인스턴스를 만든다.
 * 3. 이 인스턴스를 각각의 쓰레드에 넘겨준다.
 * 4. 각각의 쓰레드는 이 인스턴서의 참조값을 저장한 변수를 이용하여
 * 		공통데이터를 사용한다.
 * 
...
class ShareData{
	...
	/*
	 * volatile => 선언된 변수를 커뮤ㅏ일러의 최적화 대상에서 제외시킨다.
...
class PrintPIThread extends Thread{
	...
	public void run() {
		...
		System.out.println("       PI : " + Math.PI); //이클립스에서 제공해주는 것
	}
}
