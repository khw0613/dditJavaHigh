package singgleton.member.main;
...
import singgleton.member.service.MemberServiceImpl;
import singgleton.member.vo.MemberVO;
import util.DBUtil;
import util.DBUtil3;
...
public class MemberMain {
	...
	public void searchMember(){
		...
		ArrayList<MemberVO> memList = 
				(ArrayList<MemberVO>) memService.getSearchMember(mv);
