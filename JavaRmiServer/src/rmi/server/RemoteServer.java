...
import rmi.inter.RemoteInterface;
...
public class RemoteServer  extends UnicastRemoteObject implements RemoteInterface{
   ...
   //RMI용 인터페이스를 구현한 객체의 생성자 RemoteException을 throws 하도록 작성한다.
   ...
   public static void main(String[] args) {
      try {
         //구현한 RMI용 객체를 클라이언트에서 사용할수 있도록 RMI서버에 등록한다
         ...
         //형식) Registry객체변수.rebind("객체의 Alias", 등록할 객체 변수);
