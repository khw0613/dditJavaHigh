...
//			files[1] = new File("d:/D_Other/Hydrageas.jpg");
			files[0] = new File("/Users/macbook/D_Other/Desert.jpg");
			files[1] = new File("/Users/macbook/D_Other/Hydrangeas.jpg");
			
			FileInfoVO[] fInfo = new FileInfoVO[files.length];
			
			// 2개의 파일을 읽어서 byte[] 에 담아서 서버측 메서드에 전달하면된다.
			FileInputStream fin;
