...
public class B_FileTest {
	...
	public static void main(String[] args) {
		...
		File f1 = new File("/Users/macbook/D_Other/sample.txt");
		File f2 = new File("/Users/macbook/D_Other/test.txt");
		...
		File f3 = new File("/Users/macbook/D_Other");
		...
		File f4 = new File("/Users/macbook/공유폴더");   
	...
	public static void displayFileList(File dir){
		System.out.println("[" + dir.getAbsolutePath() + "] 디렉토리의 내용"); //경로 보여지는 
		...
		// 날짜를 출력하기 위한 형식 설정
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd a hh:mm");//년도 월 일 오전 or 오후 시 분
		...
		for(int i=0; i<files.length; i++){
			...
			System.out.printf("%s %5s %12s %s\n",
					sdf.format(new Date(files[i].lastModified())), attr,//마지막 수정 날짜
