...
public class Enum {
	...
	//데이터값을 정해 중 경우에는 생성자를 만들어서 괄호속의 값이 변수에 저장되도록 해야한다.
	public enum Season{
	...
	public static void main(String[] args) {
		...
		//값은 같지만 타입이 다른경우.
		//System.ou.println(EnumCard.Kind.CLOVER == EnumCard.Value.TWO);
		/*
		 * 열거형에 사용되는 메서드
		...
		//열거형 객체변수에 값 저장하기
		mycity1 = City.valueOf("서울"); // City enum 에서 '서울' 데이터르 가져온다.
		mycity2 = City.서울;
