...
public class MenuTest extends Application {
   ...
   public void start(Stage primaryStage) throws Exception {
      ...
      CheckMenuItem csslMenuItem = new CheckMenuItem("CSS");
      csslMenuItem.setSelected(true);
      
      webMenu.getItems().addAll(htmlMenuItem, csslMenuItem);
      //------------------------------------------------------
