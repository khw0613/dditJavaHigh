...
public class DialogTest extends Application {
   ...
   public void start(Stage primaryStage) throws Exception {
      ...
      btnPopup.setOnAction(e->{
         ...
         imgView.setImage(
               new Image(getClass().getResource("images/ok.png").toString())
               );
         ...
         popup.setAutoHide(true);//자동 숨김 처리 
      ...
      root.getChildren().addAll(btnFileSave,btnFileOpen,btnPopup,btnDirectory,btnCustom);
