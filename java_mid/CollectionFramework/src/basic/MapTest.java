...
public class MapTest {
	/*
	 * Map => key값과 value값을 한  쌍으로 관리한 객체
	...
	public static void main(String[] args) {
		...
		//		  이 Entry클래스는 key와 values라는 멤버변수로 구서오디어 있다.
		//		  Map에서 이 Entry클래스들을 Set형식으로 저장하여 관리한다.
		
		// Entry객체 전체를 가져오기(가져운 Entry들은 Set형식으로 되어 있다.
		...
		while(entryIt.hasNext()) { //쌍으로 set형으로 바로 뽑아 올수 있다.
